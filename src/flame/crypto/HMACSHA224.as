...
package flame.crypto
{
	...
	/**
	 * Computes a Hash-based Message Authentication Code (HMAC) using the SHA-224 hash function.
	 * This class cannot be inherited.
	 * <p>HMAC-SHA-224 is a type of keyed hash algorithm that is constructed from the SHA-224 hash function
	 ...
	 * The output hash is 224 bits long.</p>
	 ...
	 * <p>HMAC-SHA-224 accepts all key sizes and produces a hash sequence that is 224 bits long.</p>
	 */
	public final class HMACSHA224 extends HMAC
	{
		...
		/**
		 * Initializes a new instance of the HMACSHA224 class.
		 * 
		 * @param key The secret key for HMAC-SHA-224 encryption. The key can be any length,
		 * but if it is more than 64 bytes long it will be hashed (using SHA-224) to derive a 64-byte key.
		 * Therefore, the recommended size of the secret key is 64 bytes.
		 */	
		public function HMACSHA224(key:ByteArray = null)
		{
			blockSize = 64;
			
			setHashAlgorithm("SHA224");
