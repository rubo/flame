...
package flame.validators
{
	...
	/**
	 * The RegExpValidator is an enhancment to the standard RegExpValidator.
	 * It provides a bindability and adds an ability to specify a description for the associated source.
	 * 
	 * @see mx.validators.RegExpValidator
	 */
	public class RegExpValidator extends mx.validators.RegExpValidator implements IBindableValidator
	{
		//--------------------------------------------------------------------------
	    //
	    //  Fields
		...
		/**
		 * Initializes a new instance of the RegExpValidator class.
		 */
