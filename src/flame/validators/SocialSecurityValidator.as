...
package flame.validators
{
	...
	/**
	 * The SocialSecurityValidator is an enhancment to the standard SocialSecurityValidator.
	 * It provides a bindability and adds an ability to specify a description for the associated source.
	 * 
	 * @see mx.validators.SocialSecurityValidator
	 */
	public class SocialSecurityValidator extends mx.validators.SocialSecurityValidator implements IBindableValidator
	{
		//--------------------------------------------------------------------------
	    //
	    //  Fields
		...
		/**
		 * Initializes a new instance of the SocialSecurityValidator class.
		 */
