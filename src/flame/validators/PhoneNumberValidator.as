...
package flame.validators
{
	...
	/**
	 * The PhoneNumberValidator is an enhancment to the standard PhoneNumberValidator.
	 * It provides a bindability and adds an ability to specify a description for the associated source.
	 * 
	 * @see mx.validators.PhoneNumberValidator
	 */
	public class PhoneNumberValidator extends mx.validators.PhoneNumberValidator implements IBindableValidator
	{
		//--------------------------------------------------------------------------
	    //
	    //  Fields
