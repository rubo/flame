...
package flame.controls.mx
{
	...
	/**
	 * Adds a watermark feature to the standard TextArea.
	 * <p>When a watermarked TextArea is empty, it displays a message to the user with a custom style.
	 * Once the user has typed some text into the TextArea, the watermarked appearance goes away.
	 * The typical purpose of a watermark is to provide more information to the user
	 * about the TextArea itself without cluttering up the rest of the UI.</p>
	 * 
	 * @see mx.controls.TextArea
	 */
	public class WatermarkTextArea extends TextArea
	{
		//--------------------------------------------------------------------------
	    //
	    //  Fields
		...
		/**
		 * Initializes a new instance of the WatermarkTextArea class.
		 */
		public function WatermarkTextArea()
		{
			super();
